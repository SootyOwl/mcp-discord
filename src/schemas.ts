...
export const SendMessageSchema = z.object({
    ...
    notifyRepliedUser: z.boolean({ description: "Ping the replied-to user." }).default(false)
}, {
...
export const ReadMessagesSchema = z.object({
    ...
    limit: z.number({ description: "Number of recent messages to fetch (1-100)." }).min(1).max(100).default(5),
}, {
